...
jQuery(document).ready(function () {
	...
	jQuery('#btn_add_curr').click(function () {
		...
		jQuery('#wmc_sort #temp_wmc_currency').attr('name', 'wmc_currency[]').attr('id', 'wmc_currency');
		// jQuery('#wmc_sort .wmc_wrap').last().find('.wmc_select2').select2();
		jQuery('#wmc_sort #temp_wmc_pos').attr('name', 'wmc_pos[]').attr('id', 'wmc_pos');
