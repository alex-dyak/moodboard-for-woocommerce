=== Woo Multi Currency - The best free currency exchange plugin - Run smoothly on WooCommerce 3.x===
Contributors: mrt3vn
...
>[Try the Demo](http://new2new.com/?item=woo-multi-currency "Demo Woo Multi Currency") | [Documents](http://docs.villatheme.com/?item=woo-multi-currency "Documents") | [Pro Version](https://goo.gl/yaOf6s "Pro Version")
...
&#9658; **Support many currencies:** Bitcoin....
...
&#9658; **Compatible:** WooCommerce Subscriptions plugin.
...
&#9658; [Access our documents](http://docs.villatheme.com/woo-multi-currency/).
...
&#9658; [GET PRO VERSION NOW](https://goo.gl/yaOf6s)
...
- [Getting Started](http://docs.villatheme.com/woo-multi-currency/)

### Plugin Links

- [Project Page](http://villatheme.com)
- [Documentation](http://docs.villatheme.com/woo-multi-currency/)
...
/*1.5.1 - 2017.10.19*/
- Fixed: Add Sale price filter
- Fixed: Symbol on Order received page

/*1.5.0 - 2017.10.16*/
- Fixed: Coupon
- Compatible with WooCommerce Boost Sale
- Removed: Select2

/*1.4.9 - 2017.10.13*/
- Fixed: Compatible with WooCommerce 3.2
- Fixed: Currency symbol in account page

/*1.4.8.9.4 - 2017.09.26*/
- Added: Compatible with WooCommerce Advanded Free Shipping

/*1.4.8.9.3 - 2017.05.31*/
- Fixed: URL with subfolder on checkout page

/*1.4.8.9.2 - 2017.05.17*/
- Fixed: Allow multi Payment
- Added: Support Bitcoin

/*1.4.8.9.1 - 2017.05.12*/
- Updated: Currency symbol

/*1.4.8.9 - 2017.05.10*/
- Fixed: Allow multi currency

/*1.4.8.8 - 2017.05.06*/
- Fixed: Conflict Select2 with WooCommerce

/*1.4.8.7 - 2017.05.06*/
- Fixed: Price on WooCommerce 3.0

/*1.4.8.6 - 2017.04.28*/
- Fixed: Error wp-admin and subtotal cart

/*1.4.8.5 - 2017.04.27*/
- Fixed: Exchange rate mini cart

/*1.4.8.4 - 2017.04.20*/
- Fixed: Tax on shipping on WooCommerce 3.0

/**v.1.4.8.3 - 2017.04.11 */
- Fixed: Convert price in WooCommerce 3.0 or higher

/**v.1.4.8.1 - 2017.04.11 */
- Added: Compatible with WooCommerce Subscriptions
...
/**v.1.4.6 - 2017.2.1 */
- Fixed: Min and Max value of Coupon

/**v.1.4.5 - 2017.1.6 */
- Fixed: Shipping with allow multi payment
- Added: Global function change price

/**v.1.4.4 - 2016.12.20 **/
- Fixed: Change URL with variable on URL
- Fixed: Filter price
...
- Fixed: Filter price with WooCommerce new version
