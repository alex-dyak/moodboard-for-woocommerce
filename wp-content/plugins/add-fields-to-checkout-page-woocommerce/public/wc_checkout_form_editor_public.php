...
/**
	...
	function wcfe_display_custom_fields_in_emails_lite($keys){
		$custom_keys = array();
		$fields = array_merge($this->get_fields_woo('billing'), $this->get_fields_woo('shipping'),
		$this->get_fields_woo('additional'));
	...
	function wcfe_order_details_after_customer_details_lite($order){
		...
		if(!wc_ship_to_billing_address_only() && $order->needs_shipping_address()){
			...
			$fields = array_merge($this->get_fields_woo('billing'), $this->get_fields_woo('additional'));
		}
